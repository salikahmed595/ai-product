    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "var(--bg-base)" }}>
        <div className="w-full max-w-md text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-6" style={{ background: "rgba(16,185,129,0.15)", border: "1px solid rgba(16,185,129,0.3)" }}>
          ...
          <Link href="/login" className="btn-primary text-white px-6 py-3 rounded-xl text-sm font-semibold inline-block">
            Back to sign in
          </Link>
        </div>
      </div>
        ...
        <div className="rounded-2xl p-8" style={{ background: "rgba(17,17,24,0.9)", border: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center px-4 py-3 rounded-xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}>
                ...
                <input
                  ...
                  className="bg-transparent border-none outline-none text-sm text-white w-full placeholder:text-gray-600"
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="ml-2 shrink-0" style={{ color: "var(--text-muted)" }}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl text-sm font-semibold text-white flex items-center justify-center gap-2 btn-primary mt-2"
            >
              {loading ? <div className="w-4 h-4 rounded-full border-2 border-white border-t-transparent animate-spin" /> : "Create account"}
            </button>
          </form>
        </div>
